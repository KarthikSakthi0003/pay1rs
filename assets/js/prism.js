              ...
              for (var p in r)
                if (r.hasOwnProperty(p) && r[p]) {
                  ...
                  for (var m = 0; m < g.length; ++m) {
                    ...
                    for (
                      var k = f.pattern || f, x = o.next, F = 0;
                      x !== n.tail && !(d && F >= d.reach);
                      F += x.value.length, x = x.next
                    ) {
                      var P = x.value;
                      ...
                      if (!(P instanceof i)) {
                        var w,
                          A = 1;
                        if (b) {
                          if (!(w = s(k, F, t, v)) || w.index >= t.length)
                            break;
                          var C = w.index,
                            S = w.index + w[0].length,
                            E = F;
                          for (E += x.value.length; C >= E; )
                            E += (x = x.next).value.length;
                          if (((F = E -= x.value.length), x.value instanceof i))
                            continue;
                          for (
                            var L = x;
                            L !== n.tail &&
                            (E < S || "string" == typeof L.value);
                            L = L.next
                          )
                            A++, (E += L.value.length);
                        ...
                        var j = x.prev;
                        if (
                          (z && ((j = l(n, j, z)), (F += z.length)),
                          u(n, j, A),
                          (x = l(
                            n,
                            j,
                            new i(p, h ? a.tokenize(N, h) : N, y, N)
                          )),
                          _ && l(n, x, _),
                          A > 1)
                        ) {
                          var M = { cause: p + "," + m, reach: T };
                          e(t, n, r, x.prev, F, M),
        ...
        Prism.hooks.add("complete", function (n) {
          if (n.code) {
            ...
            if (
              ...
              (s = document.createElement("span")).setAttribute(
                "aria-hidden",
                "true"
              ),
    ...
    Prism.hooks.add("before-sanity-check", function (e) {
      ...
      if (!e.code) {
        ...
        1 === i.length &&
          ...
          (t.textContent = e.code = i[0].textContent);
      }
    })),
  (function () {
    if (void 0 !== Prism) {
          ...
          if (
            ...
            if ((e.element && e.element.parentNode) || !e.code) {
              ...
              if (e.code && r && "pre" === r.nodeName.toLowerCase()) {
                ...
                for (
                  var l = r.childNodes, u = "", c = "", d = !1, p = 0;
                  p < l.length;
                  ++p
                ) {
                  var g = l[p];
                  g == e.element
                    ? (d = !0)
                    : "#text" === g.nodeName &&
                      (d ? (c += g.nodeValue) : (u += g.nodeValue),
                      r.removeChild(g),
                      --p);
                }
                if (e.element.children.length && Prism.plugins.KeepMarkup) {
                  var m = u + e.element.innerHTML + c;
                  (e.element.innerHTML = n.normalize(m, e.settings)),
      ...
      var r = (Prism.plugins.toolbar.registerButton = function (n, r) {
        ...
        a = (Prism.plugins.toolbar.hook = function (r) {
          ...
          if (
            ...
            !a.parentNode.classList.contains("code-toolbar")
          ) {
      ...
      (Prism.plugins.toolbar
        ? Prism.plugins.toolbar.registerButton(
            ...
            function (t) {
              ...
              (a.className = "copy-to-clipboard-button"),
